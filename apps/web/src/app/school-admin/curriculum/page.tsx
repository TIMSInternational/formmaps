...
export default function CurriculumPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Header */}
      <div>
        <h1 style={{ fontSize: 20, fontWeight: 600, color: "var(--admin-font-primary)", letterSpacing: "-0.01em" }}>Curriculum Frameworks</h1>
        <p style={{ fontSize: 13, color: "var(--admin-font-tertiary)", marginTop: 2 }}>Enable and configure AP, IB, National, or custom frameworks</p>
      </div>
      ...
      <div style={{ borderRadius: 8, border: "1px solid var(--admin-border-default)", background: "var(--admin-bg-card)", overflow: "hidden" }}>
        <div style={{ padding: "14px 18px", borderBottom: "1px solid var(--admin-border-default)", display: "flex", alignItems: "center", gap: 10 }}>
          <div style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(59,130,246,0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
            <Settings2 style={{ width: 16, height: 16, color: "#3b82f6" }} />
          </div>
          <div>
            ...
            {safeFrameworks.map((fw) => (
              <div key={fw.type} onClick={() => { setSelectedType(fw.type); setCoursePage(1); setCourseSearch(""); }}
                style={{
                  ...
                  border: selectedType === fw.type ? "1px solid #3b82f6" : "1px solid var(--admin-border-default)",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  <div style={{
                    ...
                    <Layers style={{ width: 16, height: 16, color: fw.enabled ? "#3b82f6" : "var(--admin-font-tertiary)" }} />
                  </div>
                ...
                <div style={{ fontSize: 12, color: fw.enabled ? "#3b82f6" : "var(--admin-font-tertiary)" }}>{fw.courseCount || 0} courses</div>
              </div>
            ))}
          </div>
        </div>
