      ...
      <div className="flex items-center justify-between">
        ...
        <button onClick={handleHeaderAction} disabled={isLoading || isFetching}
          ...
          style={{
            ...
            background: isLoading || isFetching || !eligible ? "var(--admin-bg-hover)" : "linear-gradient(135deg, #8b5cf6, var(--admin-accent-blue))",
      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
            {[
              { label: t("insights.metrics.students"), value: metrics.totalStudents || 0, icon: Users, color: "var(--admin-accent-blue)" },
            ...
            <div style={{ borderRadius: 12, border: "1px solid var(--admin-border-default)", background: "var(--admin-bg-card)", overflow: "hidden" }}>
              ...
              <div style={{ padding: 16 }} className="space-y-3">
                {urgentActions.map((a: Record<string, unknown>, i: number) => {
                  ...
                  const color = impact === "high" ? "#ef4444" : impact === "medium" ? "#f59e0b" : "var(--admin-accent-blue)";
                  return (
            ...
            <div style={{ borderRadius: 12, border: "1px solid var(--admin-border-default)", background: "var(--admin-bg-card)", overflow: "hidden" }}>
              <div style={{ padding: "14px 20px", borderBottom: "1px solid var(--admin-border-default)", background: "var(--admin-bg-hover)", display: "flex", alignItems: "center", gap: 10 }}>
                <div style={{ width: 32, height: 32, borderRadius: 8, background: "rgba(59,130,246,0.1)", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Lightbulb style={{ width: 16, height: 16, color: "var(--admin-accent-blue)" }} />
                </div>
                <div>
              ...
              <div style={{ padding: 16 }} className="space-y-3">
                {insights.length === 0 ? (
                  ...
                  const catColor: Record<string, string> = { academic: "#10b981", assessment: "#8b5cf6", graduation: "var(--admin-accent-blue)", staffing: "#f59e0b", engagement: "#ef4444" };
            ...
            <div style={{ borderRadius: 12, border: "1px solid var(--admin-border-default)", background: "var(--admin-bg-card)", overflow: "hidden" }}>
              ...
              <div style={{ padding: 16 }} className="space-y-3">
                {recommendations.map((rec: Record<string, unknown>, i: number) => {
                  const catColor: Record<string, string> = { course_offering: "#10b981", staffing: "var(--admin-accent-blue)", assessment: "#8b5cf6", academic: "#f59e0b" };
