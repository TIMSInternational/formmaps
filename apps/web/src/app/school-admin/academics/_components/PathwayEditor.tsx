    ...
    <div className="flex flex-col h-full min-h-0">
      ...
      <div className="flex flex-row items-center gap-3 px-5 py-3" style={{ borderBottom: "1px solid var(--admin-border-default)" }}>
        ...
        <button
          ...
          style={{
            ...
            background: !dirty || readOnly ? "var(--admin-bg-hover)" : "var(--admin-accent-blue)",
      ...
      {isLoading ? (
        <div className="flex-1 flex items-center justify-center">
          <Loader2 style={{ width: 26, height: 26, color: "var(--admin-accent-blue)", animation: "spin 1s linear infinite" }} />
        </div>
      ) : isError ? (
        <div className="flex-1 flex items-center justify-center">
