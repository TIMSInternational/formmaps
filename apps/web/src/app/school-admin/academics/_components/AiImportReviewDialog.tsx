                ...
                <TableBody>
                  {data.courses.map((c, i) => (
                    <TableRow key={i}>
                      ...
                      <TableCell>
                        {c.frameworkType ? (
                          <Badge style={{ fontSize: 10, background: c.frameworkType === "AP" ? "var(--admin-accent-blue)20" : c.frameworkType === "IB" ? "#8b5cf620" : "#14b8a620", color: c.frameworkType === "AP" ? "var(--admin-accent-blue)" : c.frameworkType === "IB" ? "#8b5cf6" : "#14b8a6", border: "none" }}>
                            {c.frameworkType}
                          </Badge>
                        ) : (
