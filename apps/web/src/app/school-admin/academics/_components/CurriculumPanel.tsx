            ...
            {safeFrameworks.map((fw) => (
              <div key={fw.type} onClick={() => { setSelectedType(fw.type); setCoursePage(1); setCourseSearch(""); }}
                style={{
                  ...
                  border: selectedType === fw.type ? "1px solid var(--admin-accent-blue)" : "1px solid var(--admin-border-default)",
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
                  <div style={{
                    ...
                    <Layers style={{ width: 16, height: 16, color: fw.enabled ? "var(--admin-accent-blue)" : "var(--admin-font-tertiary)" }} />
                  </div>
