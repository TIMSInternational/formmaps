        ...
        <div key={si} style={{ borderRadius: 12, border: "1px solid var(--admin-border-default)", background: "var(--admin-bg-card)", overflow: "hidden" }}>
          <div style={{
            ...
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{
                ...
                display: "flex", alignItems: "center", justifyContent: "center",
                fontSize: 12, fontWeight: 700, color: si === 0 ? "var(--admin-accent-blue)" : "var(--admin-font-tertiary)",
              }}>{si + 1}</div>
          ...
          <div style={{ padding: 16 }} className="space-y-3">
            {sem.courses.map((course) => {
              const priorityColor = course.priority === "critical" ? "#ef4444" : course.priority === "recommended" ? "#f59e0b" : "var(--admin-accent-blue)";
