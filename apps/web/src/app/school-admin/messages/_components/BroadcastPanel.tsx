...
const GROUPS = [
  { key: "students", label: "All Students", icon: GraduationCap, color: "#2E9098" },
    ...
    <div style={{ display: "flex", flexDirection: "column", gap: 20 }}>
      ...
      <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }}>
        ...
        <h1 style={{ fontSize: 28, fontWeight: 700, color: "var(--admin-font-primary)", marginTop: 4, letterSpacing: "-0.02em", display: "flex", alignItems: "center", gap: 10 }}>
          <Megaphone style={{ width: 24, height: 24, color: "#2E9098" }} />
          Broadcast Message
        </h1>
      ...
      >
        ...
        <div>
          ...
          <textarea
            ...
            onFocus={(e) => { e.currentTarget.style.borderColor = "var(--admin-accent-blue, #2E9098)"; }}
          ...
          {!showConfirm && (
            <button
              ...
              style={{
                ...
                display: "flex", alignItems: "center", gap: 8,
                background: canSend ? "#2E9098" : "var(--admin-bg-hover)",
