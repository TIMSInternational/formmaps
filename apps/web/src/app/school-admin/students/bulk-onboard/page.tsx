...
/**
 * Students bulk-onboard page.
 * Reuses the refactored step components from the users/bulk-onboard module.
 * Only the page wrapper lives here so the /school-admin/students/bulk-onboard route resolves.
 */
...
import { CompleteStep } from "../../users/bulk-onboard/_components/complete-step";
import {
  genId,
  mapPreviewResponse,
  mapOnboardResponse,
} from "../../users/bulk-onboard/_components/types";
