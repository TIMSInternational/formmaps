            ...
            {targets.map((c) => (
              <label
                ...
                style={{
                  ...
                  border: targetId === c.id ? "1px solid var(--admin-accent-blue)" : "1px solid transparent",
              ...
              >
                <div style={{
                  ...
                  fontSize: 10, fontWeight: 700, color: targetId === c.id ? "var(--admin-accent-blue)" : "var(--admin-font-primary)",
                }}>
