      ...
      >
        <TableCell className="pl-4">
          <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
            <div style={{ color: expanded ? "var(--admin-accent-blue)" : "var(--admin-font-tertiary)" }}>
                    ...
                    <div key={s.id} className="group" style={{
                      ...
                      >
                        ...
                        <div style={{ minWidth: 0 }}>
                          <div style={{ fontSize: 12, fontWeight: 600, color: "var(--admin-accent-blue)", display: "flex", alignItems: "center", gap: 4 }}>
                ...
                availableStudents.map((s: StudentInfo) => (
                  <label
                    ...
                    style={{
                      ...
                      border: selected.has(s.id) ? "1px solid var(--admin-accent-blue)" : "1px solid transparent",
