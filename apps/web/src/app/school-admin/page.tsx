  ...
  return (
    <div style={{ borderRadius: 8, border: "1px solid var(--admin-border-default)", background: "var(--admin-bg-card)", padding: 16 }}>
      <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 12 }}>
        <ClipboardCheck style={{ width: 14, height: 14, color: "var(--admin-accent-blue)" }} />
    ...
    <ErrorBoundary>
      <div style={{ display: "flex", flexDirection: "column", gap: 20, color: "var(--admin-font-primary)" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(160px, 1fr))", gap: 10 }}>
          {[
            { label: t("dashboard.stats.students"), value: stats?.totalStudents?.toLocaleString() || "—", icon: Users, color: "var(--admin-accent-blue)" },
