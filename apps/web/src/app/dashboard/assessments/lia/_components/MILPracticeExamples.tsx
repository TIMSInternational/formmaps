    ...
    return (
      <div className="min-h-screen bg-secondary flex items-center justify-center">
        <div className="text-center">
          <div className="w-8 h-8 border-4 border-[#2E9098] border-t-transparent rounded-full animate-spin mx-auto mb-4"></div>
            ...
            <div className="flex flex-col sm:flex-row gap-2 sm:gap-4">
              {!showFeedback ? (
                <button
                  ...
                  className="bg-[#102B47] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg hover:bg-[#0b1f33] transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-sm sm:text-base"
                >
                ...
                <>
                  {!isCorrect ? (
                    ...
                    <button
                      onClick={handleContinue}
                      className="bg-[#102B47] text-white px-4 py-2 sm:px-6 sm:py-3 rounded-lg hover:bg-[#0b1f33] transition-colors text-sm sm:text-base"
                    >
