      ...
      <div className="bg-card border border-border rounded-lg p-6 mb-6">
            ...
            <button
              ...
              className={`w-12 h-12 rounded-lg font-bold text-lg transition-all duration-100 ${
                selectedAnswers[questionIndex] === option
                  ? "bg-[#102B47] text-white shadow-xl transform scale-110 ring-4 ring-[#2E9098]/30"
        ...
        <div className="bg-secondary border border-border rounded-lg p-4">
          ...
          <div className="mt-3 flex gap-4 text-sm">
            ...
            <div className="px-3 py-1 rounded bg-[#102B47]/10 text-[#0b1f33]">
      ...
      <div className="max-w-4xl mx-auto py-8 px-4">
        ...
        <div className="bg-card border border-border rounded-lg p-6 mb-8">
          ...
          <div className="flex gap-6 text-sm">
            <div className="flex items-center gap-2">
              <div className="w-3 h-3 bg-[#102B47] rounded-full"></div>
        ...
        <div className="bg-card border border-border rounded-lg p-6 mt-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            <div className="text-center p-4 bg-[#102B47]/5 rounded-lg">
              <div className="text-2xl font-bold text-[#2E9098]">
                {exam.questions.length}
              </div>
              <div className="text-sm text-[#0b1f33]">Total Questions</div>
            </div>
