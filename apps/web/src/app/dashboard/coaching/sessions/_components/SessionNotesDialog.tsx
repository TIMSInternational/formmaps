      ...
      <DialogContent className="max-w-2xl p-0 overflow-hidden">
        <DialogHeader className="p-6 pb-2">
          <DialogTitle className="text-2xl font-bold flex items-center gap-3">
            <div className="h-10 w-10 rounded-full bg-[var(--admin-accent-blue)]/10 flex items-center justify-center">
              <FileText className="h-5 w-5 text-[var(--admin-accent-blue)]" />
            </div>
