          ...
          <div className="space-y-8 lg:col-span-2">
            ...
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 md:p-8">
              <div className="flex items-center gap-3 mb-6">
                <div className="p-2.5 bg-[var(--admin-accent-blue)]/10 rounded-xl text-[var(--admin-accent-blue)]">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      className="h-11 rounded-xl border-gray-200 focus:ring-[var(--admin-accent-blue)]/20 focus:border-[var(--admin-accent-blue)]"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="h-11 pl-9 rounded-xl border-gray-200 focus:ring-[var(--admin-accent-blue)]/20 focus:border-[var(--admin-accent-blue)]"
                      />
                    </div>
                  </div>
                </div>
