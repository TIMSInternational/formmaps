...
export function QuestionCard({ question, onEdit, onDelete, onToggleActive }: QuestionCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`group bg-white rounded-2xl border ${question.isActive ? 'border-gray-100' : 'border-gray-200 bg-gray-50/50'} p-6 transition-all hover:shadow-md hover:border-[var(--admin-accent-blue)]/20`}
    >
      <div className="flex flex-col md:flex-row gap-6">
        ...
        <div className="flex-1 space-y-3">
          <div className="flex flex-wrap gap-2 mb-1">
            <Badge className="bg-[var(--admin-accent-blue)]/10 text-[var(--admin-accent-blue)] hover:bg-[var(--admin-accent-blue)]/20 border-0 rounded-lg px-2.5 py-0.5 font-medium">
