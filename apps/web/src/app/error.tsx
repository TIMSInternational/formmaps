  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center px-6">
      <div className="text-center max-w-md">
        ...
        <p className="text-xs font-semibold tracking-[0.2em] text-[var(--admin-accent-blue)] mb-2">500</p>
        <h2 className="text-2xl font-semibold mb-2">{copy.title}</h2>
        <p className="text-muted-foreground mb-8">{copy.desc}</p>
        <div className="flex gap-3 justify-center">
          <button
            onClick={reset}
            className="inline-flex items-center justify-center rounded-md bg-[var(--admin-accent-blue)] px-6 py-2.5 text-sm font-medium text-white hover:bg-[#247379] transition-colors"
          >
            {copy.retry}
          </button>
          <a
