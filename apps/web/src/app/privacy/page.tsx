    ...
    <main className="max-w-3xl mx-auto px-6 py-16">
      ...
      <div className="prose prose-sm dark:prose-invert space-y-6">
        ...
        <section>
          ...
          <p>For privacy-related inquiries, contact us at <a href="mailto:privacy@formmaps.ai" className="text-[var(--admin-accent-blue)] underline">privacy@formmaps.ai</a>.</p>
        </section>
      </div>
    </main>
  );
