...
export function MiniBar({ earned, required, color = "var(--admin-accent-blue)", height = 4 }: {
            ...
            <>
              <button
                ...
                style={{
                  ...
                  fontSize: 11, fontWeight: 600, color: "var(--admin-accent-blue)",
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
                      {matching.map((r, i) => (
                        <div key={i} style={{
                          ...
                          <BookOpen style={{ width: 13, height: 13, color: "var(--admin-accent-blue)", flexShrink: 0 }} />
