...
export default function CounselorInsightsPage() {
  ...
  const gpaRanges = [
    ...
    { key: "3.5-3.9", label: "3.5 - 3.9", color: "#3b82f6" },
    ...
    <div className="space-y-6">
      ...
      {isLoading ? (
        ...
        <>
          ...
          >
            {[
              { label: "TOTAL STUDENTS", value: total, icon: Users, color: "#6366f1" },
              ...
              { label: "ASSESSMENT COMPLETION", value: `${assessmentRate}%`, icon: ClipboardCheck, color: "#3b82f6" },
            ].map((stat) => (
            ...
            <div style={{
              ...
              <div style={{ padding: "16px 20px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                  ...
                  <span style={{ fontSize: 12, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", color: "#6366f1" }}>AI Briefing</span>
                </div>
                <button onClick={() => refetchBriefing()} disabled={briefingFetching} style={{
                  ...
                  background: briefingFetching ? "var(--admin-bg-hover)" : "linear-gradient(135deg, #6366f1, #4f46e5)",
                ...
                <div style={{ padding: "0 20px 16px 20px" }}>
                  ...
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {urgentActions.map((a: any, i: number) => {
                      const impactColor = a.impact === "high" ? "#ef4444" : a.impact === "medium" ? "#f59e0b" : "#3b82f6";
                      return (
          ...
          >
            {[
              ...
              { label: "MIL Complete", complete: milComplete, color: "#3b82f6" },
