...
export const schoolAdminKeys = {
  ...
  studentList: (params: Record<string, unknown>) => [...schoolAdminKeys.students(), "list", params] as const,
  ...
  resultList: (params: Record<string, unknown>) => [...schoolAdminKeys.results(), "list", params] as const,
