  ...
  return (
    <div className="h-screen bg-white flex overflow-hidden">
      ...
      <div className="flex-1 flex flex-col h-full overflow-y-auto overflow-x-hidden bg-gray-50/30 relative">
        {/* Decorative Graphic */}
        <div className="absolute top-0 right-0 -mt-20 -mr-20 w-96 h-96 bg-gradient-to-br from-[var(--admin-accent-blue)]/20 to-purple-100/40 rounded-full blur-3xl pointer-events-none" aria-hidden="true"></div>
