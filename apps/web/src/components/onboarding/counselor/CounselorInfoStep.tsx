        ...
        <div className="space-y-2">
          ...
          <div className="relative">
            ...
            <Input
              ...
              onBlur={handleBlur}
              className={`pl-11 h-12 transition-all duration-200 border-gray-200 hover:border-[#2E9098]/50 focus:border-[#2E9098] focus:ring-4 focus:ring-[#2E9098]/10 ${errors.name ? "border-red-300 focus:border-red-500 focus:ring-red-500/10" : ""}`}
            />
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                onBlur={handleBlur}
                className="pl-11 h-12 transition-all duration-200 border-gray-200 hover:border-[#2E9098]/50 focus:border-[#2E9098] focus:ring-4 focus:ring-[#2E9098]/10"
              />
            </div>
          </div>
