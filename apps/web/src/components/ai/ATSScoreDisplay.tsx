    ...
    <div className={cn("space-y-4", className)}>
      ...
      <div className="grid grid-cols-2 gap-3">
        ...
        {keywordsIncluded && keywordsIncluded.length > 0 && (
          <div className="p-3 rounded-lg border border-[var(--admin-accent-blue)]/30 bg-[var(--admin-accent-blue)]/10">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-medium text-gray-700">
                {t("ai.ats.keywords", "Keywords")}
              </span>
              <Zap className="w-4 h-4 text-[var(--admin-accent-blue)]" aria-hidden="true" />
            </div>
            <p className="text-sm font-semibold text-gray-900">
        ...
        <div className="space-y-2">
          ...
          <div className="flex flex-wrap gap-2">
            {keywordsIncluded.slice(0, 8).map((keyword, idx) => (
              <span
                key={idx}
                className="inline-flex items-center gap-1 px-2.5 py-1 rounded-full text-xs font-medium bg-[var(--admin-accent-blue)]/10 text-[var(--admin-accent-blue)] border border-[var(--admin-accent-blue)]/30"
              >
