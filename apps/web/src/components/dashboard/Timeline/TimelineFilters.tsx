    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col gap-4">
        ...
        <div className="relative group">
          <Search className="absolute left-3 top-1/2 -translate-y-1/2 h-4 w-4 text-gray-400 group-hover:text-[var(--admin-accent-blue)] transition-colors" />
          <Input
            placeholder={
            ...
            className="pl-9 h-10 bg-gray-50/50 border-gray-200 focus:bg-white focus:border-[var(--admin-accent-blue)] transition-all rounded-lg"
          />
        </div>
        ...
        <Popover>
          <PopoverTrigger asChild>
            <Button
              variant="outline"
              className={cn(
                "w-full justify-between px-3 h-10 font-normal border-gray-200 hover:bg-gray-50 hover:text-[var(--admin-accent-blue)] transition-colors rounded-lg",
                (date?.from || date?.to) && "bg-[var(--admin-accent-blue)]/10 text-[var(--admin-accent-blue)] border-[var(--admin-accent-blue)]/30"
              )}
            >
    ...
    <div className="space-y-3">
      ...
      <div className="flex items-center gap-2">
        ...
        >
          ...
          {activeFilterCount > 0 && (
            <span className="flex h-5 w-5 items-center justify-center rounded-full bg-[var(--admin-accent-blue)] text-xs text-white font-bold">
              {activeFilterCount}
            </span>
          )}
        ...
        <div className="relative flex-1">
          ...
          <Input
            ...
            className="pl-9 h-9 bg-white border-gray-200 focus:border-[var(--admin-accent-blue)] rounded-lg"
          />
        </div>
      </div>
