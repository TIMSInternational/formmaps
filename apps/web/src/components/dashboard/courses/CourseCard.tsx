  ...
  return (
    ...
    >
      ...
      >
        ...
        <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[var(--admin-accent-blue)] to-[#102B47] transform origin-left scale-x-0 group-hover:scale-x-100 transition-transform duration-300" />
        ...
        <div className="relative h-40 w-full rounded-2xl overflow-hidden mb-5">
          ...
          <div className="absolute top-3 left-3 flex flex-col gap-2">
            {isRecommended && (
              <Badge className="bg-[var(--admin-accent-blue)] hover:bg-[var(--admin-accent-blue)]/90 text-white border-none shadow-sm backdrop-blur-sm">
        ...
        <div className="flex flex-col flex-grow">
          <div className="flex items-start justify-between mb-3">
            <div>
              <h3 id={`course-${course.id}-title`} className="font-bold text-lg text-gray-900 leading-tight group-hover:text-[var(--admin-accent-blue)] transition-colors line-clamp-2 mb-1">
                {course.title}
              </h3>
          ...
          <div className="flex items-center justify-between pt-4 border-t border-gray-50 mt-auto">
            <Button
              ...
              className={`rounded-xl px-5 font-medium shadow-sm transition-all ${
                enrollmentStatus === "completed" 
                  ...
                  : "bg-gray-900 text-white hover:bg-[var(--admin-accent-blue)] hover:shadow-[var(--admin-accent-blue)]/20"
              }`}
            >
              {enrollmentStatus === "completed"
            ...
            <div className="flex items-center gap-1">
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                className="h-9 w-9 text-gray-300 group-hover:text-[var(--admin-accent-blue)] transition-colors rounded-full hover:bg-[var(--admin-accent-blue)]/10"
