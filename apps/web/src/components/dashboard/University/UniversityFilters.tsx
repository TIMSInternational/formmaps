  ...
  return (
    <motion.button
      ...
      className={cn(
        ...
        active
          ? "border-[var(--admin-accent-blue)]/30 bg-[var(--admin-accent-blue)]/10 text-[var(--admin-accent-blue)] shadow-sm ring-1 ring-[var(--admin-accent-blue)]/30"
      ...
      <div className="space-y-2">
        <div className="relative">
          ...
          <Input
            ...
            className="h-9 pl-8 text-xs bg-gray-50 border-gray-200 focus:bg-white focus:border-[var(--admin-accent-blue)] transition-all rounded-lg"
          />
        </div>
      </div>
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-2">
          <div className="relative flex-1">
            ...
            <Input
              type="number"
              className="h-8 pl-6 pr-2 text-xs bg-white border-gray-200 focus:border-[var(--admin-accent-blue)] rounded-lg"
              value={tuitionMin}
              onChange={(e) =>
      ...
      <div className="space-y-3 pt-2 border-t border-gray-100">
        <div className="flex items-center justify-between gap-2 py-1">
          ...
          <Switch
            ...
            className="scale-75 data-[state=checked]:bg-[var(--admin-accent-blue)]"
          />
        </div>
        <div className="flex items-center justify-between gap-2 py-1">
          <div className="space-y-0.5">
