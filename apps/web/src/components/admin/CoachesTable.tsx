      ...
      <div className="sticky top-4 z-20 bg-white/80 backdrop-blur-xl border border-gray-200/50 shadow-sm rounded-2xl p-2 flex flex-col md:flex-row justify-between items-center gap-4">
        <div className="flex items-center gap-2 w-full md:w-auto">
          <Select value={contractFilter} onValueChange={setContractFilter}>
            <SelectTrigger className="w-full md:w-[200px] h-11 bg-gray-50/50 border-transparent focus:bg-white focus:border-[var(--admin-accent-blue)]/20 focus:ring-4 focus:ring-[var(--admin-accent-blue)]/10 rounded-xl transition-all">
        ...
        <div className="relative w-full md:w-80 group">
          <Search className="absolute left-3 top-1/2 transform -translate-y-1/2 h-4 w-4 text-gray-400 group-focus-within:text-[var(--admin-accent-blue)] transition-colors" />
          <Input
            placeholder={t("admin.coaches.searchPlaceholder")}
            className="pl-10 h-11 bg-gray-50/50 border-transparent focus:bg-white focus:border-[var(--admin-accent-blue)]/20 focus:ring-4 focus:ring-[var(--admin-accent-blue)]/10 rounded-xl transition-all"
            value={searchTerm}
                      ...
                      <DropdownMenu>
                        ...
                        >
                          ...
                          {coach.status === "invited" && (
                            <DropdownMenuItem
                              className="rounded-lg cursor-pointer text-[var(--admin-accent-blue)] focus:text-[#102B47] focus:bg-[var(--admin-accent-blue)]/10"
                              onClick={async () => {
