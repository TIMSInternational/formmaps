...
export const modernColors = {
  primary: 'var(--admin-accent-blue)', // Vibrant Indigo - New Core Brand Color
     ...
     <Svg style={{ position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}>
         <Defs>
            <RadialGradient id="pageGlow" cx="50%" cy="0%" r="80%">
                <Stop offset="0%" stopColor="var(--admin-accent-blue)" stopOpacity="0.05" />
                <Stop offset="100%" stopColor="var(--admin-accent-blue)" stopOpacity="0" />
            </RadialGradient>
         </Defs>
