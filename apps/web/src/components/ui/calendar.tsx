  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        // Add v9 specific nav keys that match v8 behavior
        ...
        month_caption: "mx-auto flex items-center justify-self-center",
        weekdays: "flex ",
        weekday:
        ...
        hidden: "invisible",
        // v9 specific keys mapping to ensure compatibility
