        ...
        <motion.div initial={{ opacity: 0, y: 12 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
            {scheduledSessions.map((s) => {
              ...
              return (
                <div key={s.id} style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 16px", borderRadius: 10, border: `1px solid ${isReady ? "var(--admin-accent-blue)" : "var(--admin-border-default)"}`, background: "var(--admin-bg-card)", width: "100%" }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <div style={{ fontSize: 12, color: isReady ? "var(--admin-accent-blue)" : "var(--admin-font-tertiary)", marginTop: 2, display: "flex", alignItems: "center", gap: 4 }}>
