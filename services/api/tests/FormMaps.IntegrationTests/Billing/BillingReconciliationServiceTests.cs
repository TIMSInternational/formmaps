...
/// with both values; a shadow row with no live counterpart (userId not found on the live side) is
/// reported as an "existence" mismatch with a null LiveValue. Follows the same real-session-factory
