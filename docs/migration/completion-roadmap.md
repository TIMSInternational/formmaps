...
- 🔶 **school-courses.ts mini-phase (27 endpoints, being sub-sliced):**
  ...
  - ▶ remaining after FM-060: PUT/DELETE /courses/:courseId + /data-mappings/:id (need a batched negative-lookahead rewrite to exclude the Node-staying ai-suggest/ai-import siblings); AI (ai-suggest/ai-import) stays Node.
