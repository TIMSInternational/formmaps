...
- 🔶 **school-courses.ts mini-phase (27 endpoints, being sub-sliced):**
  ...
  - ⏳ curriculum frameworks (FM-055) — built, needs credits-string fold + gate before ship.
  - ▶ remaining: data-mappings (minus ai-suggest), prerequisites, course-sequence/pathways, bulk import; PUT/DELETE /courses/:courseId + the /courses/* sibling routes; AI (ai-suggest/ai-import) stays Node.
